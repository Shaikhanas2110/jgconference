          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSearch} className="space-y-4">
              ...
              <p className="text-gray-600 text-sm">
                You will find your Paper ID in the confirmation email after
                submission
              </p>
            </form>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="bg-gray-50 rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                {Object.entries(mockPaperStatus.reviewStatus).map(
                  ([reviewer, status], index) => (
                    <div
                      key={index}
            ...
            <div className="mt-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-yellow-50 rounded-lg p-6 border-l-4 border-yellow-400">
                  ...
                  <p className="text-gray-600 text-sm">
                    Your paper is currently being reviewed by our expert
                    reviewers
                  </p>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <p className="text-gray-600 mb-6">
              If you cannot find your paper status or have questions about the
