      ...
      <section className="bg-gradient-to-r from-red-900 via-red-700 to-red-800 text-white py-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-4 text-xl text-gray-200">
            The Conference on Smart Innovation for Sustainable Development Goals
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-8 mb-6">
                ...
                Goals (ICSISDG 2026) is dedicated to bringing together
                researchers, academicians, students, and industry professionals
                from around the globe to present innovative research and
                exchange ideas on emerging technologies and their applications.
              </p>
              <p className="text-gray-600 leading-8">
                We are committed to fostering a collaborative environment where
                groundbreaking research meets practical applications,
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 leading-8 mb-4">
                To create a global platform where innovative research and
                practical applications converge to address the world's most
                pressing challenges through technology and sustainable
                development.
              </p>
            </div>
            <div>
